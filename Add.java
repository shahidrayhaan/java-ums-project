...
public class Add extends JFrame implements ActionListener{
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource() == submit){
            ...
            try{
                String query = "insert into student values('"+name+"','"+fname+"','"+reg+"','"+dob+"','"+address+"','"+phone+"','"+email+"','"+x+"','"+xii+"','"+adhaar+"','"+course+"','"+branch+"')";
                Conn con = new Conn();
